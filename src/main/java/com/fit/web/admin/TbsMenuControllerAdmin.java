...
import com.fit.service.TbsRoleMenuService;
import com.fit.entity.TbsRoleMenuModel;

@Slf4j
@Controller
@RequestMapping("/admin/TbsMenu/")
public class TbsMenuControllerAdmin extends BaseController {
    ...
    @ResponseBody
    public Object data(PageParams pageParams, TbsMenuModel tbsMenuModel) throws Exception {
        ...
        if (lm != null && lm.size() > 0) {
            ...
            for (int i = 0; i < lm.size(); i++) {
                ...
                if (roleId != null) {
                    ...
                    if (tbsRoleMenuService.selectByEntity(tbsRoleMenuModel).size() > 0) {
